...
% Last Modified by GUIDE v2.5 26-May-2020 05:06:37
...
legend(': Spectrum',  sprintf(': Cent ±%d',getCentsRange3()) , sprintf(': Cent ±%d',getCentsRange2()), sprintf(': Cent ±%d',getCentsRange1()));
